...
//    public void addDigitalSignature(String privateKey){
//        String md = SHA1.hashString(mBody);
//        //TODO encrypt md with private key ecc
//        mBody = mBody + "\n\n<ds>" +  md + "</ds>";
//    }
//
//    public void encryptBody(String key){
//        try {
//            byte mBodyBytes[] =  Revaris.RevarisEncrypt(mBody.getBytes(), key);
//            mBody = mBodyBytes.toString();
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//    }
