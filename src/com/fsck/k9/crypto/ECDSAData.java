 ...
 */
public class ECDSAData implements Serializable{
    private static final long serialVersionUID = 6314045536470848410L;
    protected long mEncryptionKey = 0;
    ...
    // new API
    protected String mSignatureResult;

    public void setEncryptionKey(long keyId) {
        mEncryptionKey = keyId;
    }
